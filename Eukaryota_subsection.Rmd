...
# df.test <- data.frame(cbind(x = rep(1,10), y = 1:10))
# 
# p4 <- ggplot(df.test)+
#   geom_tile(aes(x = y , y = x, fill = y),
#            stat = "identity")
# 
# p4
...
p5 <- ggplot(dfOut)+
  geom_tile(aes(x = lubri,y = 0.5, fill = par),
           stat = "identity")+
  scale_fill_gradient(low = "black",high = "yellow")+
  theme_minimal()+
  geom_line(aes(x = lubri,y = norm.par,color = "red"))
