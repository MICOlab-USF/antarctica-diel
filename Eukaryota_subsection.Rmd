...
p6 <- ggplot(dfOut2)+
  ...
  facet_wrap(facets = "COG.vec",
             ...
             labeller = function(variable,value){return(name_vec[value])})+
  scale_y_continuous(label = function(y){y*100})+
  labs(title = paste("Relative TPM of each COG category for ",Class.plot,sep = ""),
       y = expression(paste("Relative TPM (%)",sep = "",)),
       x = "Day and time of sampling")+
  theme_classic()+
  theme(axis.text.x = element_text(angle = 90,
...
save.name <- paste("COG_Class_plots/",Class.plot,"COG_light_plot.png",sep = "")
